      ...
      <MacCardComponent cardsname="Staff | Status" class="col-span-12 overflow-hidden">
        <div class="grid grid-cols-2 gap-5 px-5">
          ...
          <div>
            ...
            <div>
              <select v-model="status" class="bg-white w-full rounded-md py-2 pl-5 pr-3 shadow-sm focus:outline-none border border-gray-300 focus:border-sky-500 focus:ring-sky-500 focus:ring-1 font-semibold">
